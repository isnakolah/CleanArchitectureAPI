namespace Application.Common.Models
{
    public class ServiceError
    {
        ...
        /// <summary>
        /// Use this to send a custom not found message
        /// </summary>
        public static ServiceError CustomNotFound(string resourceNotFound)
        {
            return new ServiceError($"{resourceNotFound} was not found", 990);
        }
